...
import { ABS_ERP_API_URL_2 } from '@/config/config.js';
...
export const entityService = {
  ...
  async list(params?: EntityListParams): Promise<PaginatedResponse<Entity>> {
    const response = await axios.get(`${ABS_ERP_API_URL_2}/entities`, {
      params: {
        ...params,
  ...
  async get(id: number): Promise<{ data: Entity }> {
    const response = await axios.get(`${ABS_ERP_API_URL_2}/entities/${id}`, {
      headers: getAuthHeaders()
    })
    return response.data
  },
  ...
  async create(data: CreateEntityRequest): Promise<{ data: Entity }> {
    const response = await axios.post(`${ABS_ERP_API_URL_2}/entities`, data, {
      headers: getAuthHeaders()
    })
    return response.data
  },
  ...
  async update(id: number, data: UpdateEntityRequest): Promise<{ data: Entity }> {
    const response = await axios.put(`${ABS_ERP_API_URL_2}/entities/${id}`, data, {
      headers: getAuthHeaders()
    })
    return response.data
  },
  ...
  async delete(id: number): Promise<void> {
    await axios.delete(`${ABS_ERP_API_URL_2}/entities/${id}`, {
      headers: getAuthHeaders()
    })
  },
  ...
  async updateStatus(id: number, status: string): Promise<{ data: Entity }> {
    const response = await axios.patch(
      `${ABS_ERP_API_URL_2}/entities/${id}/status`,
      { status },
      { headers: getAuthHeaders() }
    )
    return response.data
  ...
  async addContact(
    ...
    const response = await axios.post(
      `${ABS_ERP_API_URL_2}/entities/${entityId}/contacts`,
      contact,
      { headers: getAuthHeaders() }
    )
    return response.data
  ...
  async updateContact(
    ...
    const response = await axios.put(
      `${ABS_ERP_API_URL_2}/entities/${entityId}/contacts/${contactId}`,
      contact,
      { headers: getAuthHeaders() }
    )
    return response.data
  ...
  async removeContact(entityId: number, contactId: number): Promise<void> {
    await axios.delete(`${ABS_ERP_API_URL_2}/entities/${entityId}/contacts/${contactId}`, {
      headers: getAuthHeaders()
    })
  },
  ...
  async addCategory(
    ...
    const response = await axios.post(
      `${ABS_ERP_API_URL_2}/entities/${entityId}/categories`,
      categoryData,
      { headers: getAuthHeaders() }
    )
    return response.data
  ...
  async removeCategory(entityId: number, categoryId: number): Promise<void> {
    await axios.delete(`${ABS_ERP_API_URL_2}/entities/${entityId}/categories/${categoryId}`, {
      headers: getAuthHeaders()
    })
  },
  ...
  async addIdentity(
    ...
    const response = await axios.post(
      `${ABS_ERP_API_URL_2}/entities/${entityId}/identities`,
      identity,
      { headers: getAuthHeaders() }
    )
    return response.data
  ...
  async updateIdentity(
    ...
    const response = await axios.put(
      `${ABS_ERP_API_URL_2}/entities/${entityId}/identities/${identityId}`,
      identity,
      { headers: getAuthHeaders() }
    )
    return response.data
  ...
  async removeIdentity(entityId: number, identityId: number): Promise<void> {
    await axios.delete(`${ABS_ERP_API_URL_2}/entities/${entityId}/identities/${identityId}`, {
      headers: getAuthHeaders()
    })
  },
  ...
  async getCategories(): Promise<{ data: Category[] }> {
    const response = await axios.get(`${ABS_ERP_API_URL_2}/categories`, {
      headers: getAuthHeaders()
    })
    return response.data
  },
  ...
  async getIdentityTypes(): Promise<{ data: IdentityType[] }> {
    const response = await axios.get(`${ABS_ERP_API_URL_2}/identity-types`, {
      headers: getAuthHeaders()
    })
    return response.data
  },
  ...
  async getContactTypes(): Promise<{ data: ContactType[] }> {
    const response = await axios.get(`${ABS_ERP_API_URL_2}/contact-types`, {
      headers: getAuthHeaders()
    })
    return response.data
  },
  ...
  async getCountries(): Promise<{ data: Country[] }> {
    const response = await axios.get(`${ABS_ERP_API_URL_2}/settings/countries`, {
      headers: getAuthHeaders()
    })
    return response.data
  },
  ...
  async getCurrencies(): Promise<{ data: Currency[] }> {
    const response = await axios.get(`${ABS_ERP_API_URL_2}/settings/currencies`, {
      headers: getAuthHeaders()
    })
    return response.data
  },
  ...
  async getNationalities(): Promise<{ data: any[] }> {
    const response = await axios.get(`${ABS_ERP_API_URL_2}/settings/nationalities`, {
      headers: getAuthHeaders()
    })
    return response.data
  }
