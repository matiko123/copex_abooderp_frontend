...
const router = createRouter({
  ...
  routes: [
    { path: '/', component: () => import('../views/Dashboard.vue') },
		...
		//accounts routers
		{ path: '/accounts/chart-of-accounts', component: () => import('../views/accounts/chartOfAccounts.vue') },
		{ path: '/accounts/journal-vouchers', component: () => import('../views/accounts/JournalVoucher/JournalVoucher.vue') },
		{ path: '/accounts/journal-voucher/create', component: () => import('../views/accounts/JournalVoucher/JournalVoucherForm.vue') },
		{ path: '/accounts/bills-invoices', component: () => import('../views/accounts/BillingAndInvoice/BillsInvoices.vue') },

	// account settings routers
	     { path: '/settings/accounts/financial-year', component: () => import('../views/settings/accounts/index.vue') },
